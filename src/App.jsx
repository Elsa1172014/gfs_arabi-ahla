...
function Login({ onStudent, onTeacher, onAdmin, onParent, codes, students, courses = [], attempts = [] }) {
  ...
  useEffect(() => {
    if (stage === "form") { setRingsOn(false); const t = setTimeout(() => setRingsOn(true), 200); return () => clearTimeout(t); }
  }, [stage]);
      ...
      <div className="wrap lh-shell">
        {stage === "welcome" && (
          <div className="lh-hero lh-fade">
            ...
            <p style={{ color: "#C6DAD8", textAlign: "center", fontSize: 13, margin: "0 0 26px", maxWidth: 480, marginInline: "auto" }}>منصة كاملة: تعلّم للطالب، لوحة تحكم للمعلم، وحدة إدارة للقسم، وبوابة تقرير لولي الأمر.</p>
